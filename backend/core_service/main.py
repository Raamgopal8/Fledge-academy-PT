...
from routes import auth, dashboard, user, schedule, staff_logs, finance, notes, activity, notification
...
app.include_router(activity.router, prefix="/api/activity", tags=["Activity Monitoring"])
