                ...
                <div className="md:col-span-4 flex flex-col gap-5">
                    ...
                    <div className="bg-surface-container-lowest border border-outline-variant/60 rounded-3xl p-5 md:p-6 custom-shadow hover:shadow-md transition-all flex-1">
                        ...
                        <div className="space-y-2">
                            {[
                                { title: 'Manage Course Tests', href: '/sensi/tests', icon: 'quiz' },
                                { title: 'Manage Course Materials', href: '/sensi/materials', icon: 'library_books' },
                                { title: 'Check Class Schedule', href: '/sensi/schedule', icon: 'calendar_month' }
                            ].map((item, i) => (
