...
export default function StaffMaterials() {
    ...
    const [batch, setBatch] = useState(selectedBatch && selectedBatch !== 'All Assigned Batches' && selectedBatch !== 'All Batches' ? selectedBatch : '');
    ...
    return (
        <div className="max-w-[1440px] mx-auto p-4 md:px-8 lg:px-12 md:py-8 space-y-6 md:space-y-8 relative pb-32 animate-fade-in">
            ...
            {/* Filter Controls Bar */}
            <div className="bg-surface-container-lowest border border-outline-variant/60 rounded-3xl p-4 md:p-5 custom-shadow flex flex-wrap items-center justify-between gap-3">
                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {filteredMaterials.map((material) => {
                            ...
                            return (
                                <div key={material.id} className="group relative bg-surface-container-lowest rounded-3xl p-5 flex flex-col justify-between border border-outline-variant/60 hover:border-primary/50 custom-shadow hover:shadow-md transition-all">
                                    <div>
