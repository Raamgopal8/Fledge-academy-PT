                    ...
                    {DAYS_OF_WEEK.map((day) => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-center justify-between gap-3 px-3.5 py-2.5 sm:py-3 rounded-xl text-xs sm:text-sm whitespace-nowrap transition-all cursor-pointer min-w-max lg:min-w-0 lg:w-full shrink-0 ${
                                    isActive
