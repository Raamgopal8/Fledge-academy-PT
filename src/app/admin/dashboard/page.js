...
export default function AdminDashboard() {
    ...
    const [staffList, setSensiList] = useState([]);
    ...
    const fetchDashboardData = async (showLoading = false) => {
        ...
        try {
            ...
            if (staffRes.ok) {
                setSensiList(await staffRes.json());
            }
            if (studentRes.ok) {
    ...
    return (
        <div className="max-w-[1440px] mx-auto p-gutter space-y-lg relative pb-32 animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <div className="bg-surface-container-lowest border border-outline-variant/60 rounded-3xl p-5 custom-shadow hover:shadow-md transition-shadow flex flex-col justify-between group">
                    ...
                    <div className="mt-4 pt-3 border-t border-outline-variant/40 flex items-center justify-between">
                        ...
                        <a href="/admin/students" className="text-xs font-bold text-primary hover:underline flex items-center gap-0.5">
                ...
                <div className="bg-surface-container-lowest border border-outline-variant/60 rounded-3xl p-5 custom-shadow hover:shadow-md transition-shadow flex flex-col justify-between group">
                    ...
                    <div className="mt-4 pt-3 border-t border-outline-variant/40 flex items-center justify-between">
                        ...
                        <a href="/admin/sensi" className="text-xs font-bold text-primary hover:underline flex items-center gap-0.5">
                            Sensi <span className="material-symbols-outlined text-[14px]">arrow_forward</span>
                        </a>
                    </div>
                </div>
                ...
                <div className="bg-surface-container-lowest border border-outline-variant/60 rounded-3xl p-5 custom-shadow hover:shadow-md transition-shadow flex flex-col justify-between group">
                    ...
                    <div className="mt-4 pt-3 border-t border-outline-variant/40 flex items-center justify-between">
                        ...
                        <a href="/admin/materials" className="text-xs font-bold text-primary hover:underline flex items-center gap-0.5">
                ...
                <div className="bg-surface-container-lowest border border-outline-variant/60 rounded-3xl p-5 custom-shadow hover:shadow-md transition-shadow flex flex-col justify-between group">
                    ...
                    <div className="mt-4 pt-3 border-t border-outline-variant/40 flex items-center justify-between">
                        ...
                        <a href="/admin/finances" className="text-xs font-bold text-primary hover:underline flex items-center gap-0.5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
                ...
                {/* Quick Actions (Col-Span 5 - Matching Sensi Quick Actions) */}
                    ...
                    <div className="space-y-2.5 flex-1 flex flex-col justify-center">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                    <h4 className="font-bold text-xs sm:text-sm">Sensi & Faculty</h4>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                <div className="bg-surface-container-lowest border border-outline-variant/60 rounded-3xl p-5 md:p-6 custom-shadow hover:shadow-md transition-all flex flex-col max-h-[380px]">
                    <div className="flex justify-between items-center mb-4">
                        <div>
                            <h3 className="font-bold text-base md:text-lg text-on-surface">Active Sensi</h3>
                            <p className="text-xs text-on-surface-variant">Instructors and mentors</p>
                        </div>
                        <a href="/admin/sensi" className="text-xs font-bold text-primary hover:underline flex items-center gap-0.5">
                            All Sensi <span className="material-symbols-outlined text-[14px]">arrow_forward</span>
                        </a>
                    </div>
                    <div className="flex-1 overflow-y-auto space-y-2 custom-scrollbar pr-1">
                        {staffList.length > 0 ? (
            ...
            {/* Live Student & Sensi Activity Stream */}
            ...
            <div className="bg-surface-container-lowest border border-outline-variant/60 rounded-3xl p-5 md:p-6 custom-shadow hover:shadow-md transition-all flex flex-col">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <a href="/admin/tests" className="text-xs font-bold text-primary hover:underline flex items-center gap-0.5">
