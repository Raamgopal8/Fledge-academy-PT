...
export default function CEOPerformance() {
    ...
    const fetchData = useCallback(async (showLoading = false) => {
        ...
        try {
            ...
            const [summaryRes, sessionsRes, logsRes] = await Promise.all([
                fetch(`${apiBase}/api/activity/admin/summary`, { headers }),
                fetch(`${apiBase}/api/activity/admin/user-sessions?${batchParam}`, { headers }),
                fetch(`${apiBase}/api/activity/admin/logs?limit=150${batchParam}`, { headers })
            ]);
    ...
    const handleDownloadAllActivities = async () => {
        ...
        try {
            ...
            const res = await fetch(`${apiBase}/api/activity/admin/logs?limit=0`, { headers });
    ...
    const handleDeleteAllActivities = async () => {
        ...
        try {
            ...
            const res = await fetch(`${apiBase}/api/activity/admin/logs`, {
                method: 'DELETE',
                headers
            });
