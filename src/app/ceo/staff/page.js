        ...
        <section className="p-gutter max-w-[1440px] mx-auto space-y-lg">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-md mb-md">
                <div>
                    ...
                    <p className="font-body-lg text-on-surface-variant max-w-2xl">View, add, edit, and assign multiple batches to staff accounts.</p>
                </div>
                <button 
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead className="bg-surface-container-low border-b border-outline-variant">
                            <tr>
                                ...
                                <th className="p-md font-label-lg text-on-surface-variant">Assigned Batches</th>
