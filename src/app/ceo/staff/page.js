            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 mb-2 md:mb-lg">
                <div>
                    <div className="flex items-center gap-2 mb-0.5">
                        <span className="material-symbols-outlined text-primary text-2xl sm:text-4xl">manage_accounts</span>
                        <h1 className="text-2xl sm:text-4xl font-bold tracking-tight bg-gradient-to-r from-[#6FB7E4] via-[#5D8BCC] to-[#465AA3] text-transparent bg-clip-text">Staff Management</h1>
                    </div>
                    <p className="text-xs sm:text-base text-on-surface-variant max-w-2xl">View, add, edit, and assign multiple batches to staff accounts.</p>
                </div>
                <button 
